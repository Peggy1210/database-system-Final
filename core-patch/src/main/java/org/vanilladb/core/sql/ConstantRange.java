...
public abstract class ConstantRange {
	...
	public static ConstantRange newInstance(Constant low, boolean lowIncl,
		...
		} else if (type.getSqlType() == VECTOR(16).getSqlType() || type.getSqlType() == VECTOR(48).getSqlType() || type.getSqlType() == VECTOR(128).getSqlType()) {
			return new VectorConstantRange((VectorConstant) low, lowIncl, (VectorConstant) high, highIncl);
		}
